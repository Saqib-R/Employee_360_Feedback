...
@Component({
  selector: 'app-hr-feedback-overview',
  templateUrl: './hr-feedback-overview.component.html',
  styleUrl: './hr-feedback-overview.component.css'
})
export class HrFeedbackOverviewComponent {
  ...
  ngOnInit(): void {
    ...
    // }
    if(true){
      this.uploadService.getHRSummaries().subscribe({
        next: (res) => {
          // setTimeout(() => {
